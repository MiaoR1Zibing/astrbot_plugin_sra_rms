...
title: "01 - 插件开发指南"
date: 2026-06-17
description: AstrBot 插件开发完整指南，包含环境准备、目录结构、开发原则等
---
...
- [环境准备](#环境准备)
  - [获取插件模板](#获取插件模板)
  - [克隆项目到本地](#克隆项目到本地)
  - [设置插件 Logo（可选）](#设置插件-logo可选)
  - [插件展示名（可选）](#插件展示名可选)
  - [插件短描述（可选）](#插件短描述可选)
  - [随插件提供 Skills（可选）](#随插件提供-skills可选)
  - [声明支持平台（Optional）](#声明支持平台optional)
  - [声明 AstrBot 版本范围（Optional）](#声明-astrbot-版本范围optional)
  - [调试插件](#调试插件)
  - [插件依赖管理](#插件依赖管理)
- [开发原则](#开发原则)
...
> **警告**: 请务必修改此文件，AstrBot 识别插件元数据依赖于 `metadata.yaml` 文件。
...
插件展示名和描述支持按 WebUI 语言显示，详见[插件国际化](./07_插件国际化.md)。
...
- 原始文档: https://docs.astrbot.app/dev/star/plugin-new.html
- 整理时间: 2026-06-17
