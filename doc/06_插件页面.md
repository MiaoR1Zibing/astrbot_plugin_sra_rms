...
title: "06 - 插件页面"
date: 2026-06-17
description: AstrBot 插件自定义Dashboard页面开发指南
---
...
如果只是让用户填写几个配置项，优先使用 [`_conf_schema.json`](./05_插件配置.md)。插件 Pages 更适合复杂表单、Dashboard、日志、文件上传下载、SSE 和自定义交互流程。
...
- 原始文档: https://docs.astrbot.app/dev/star/guides/plugin-pages.html
- 整理时间: 2026-06-17
