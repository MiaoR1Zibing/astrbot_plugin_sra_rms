...
title: "15 - HTTP API"
date: 2026-06-17
description: AstrBot HTTP API 详解，支持外部系统集成
---
...
- [常用接口](#常用接口)
- [message 字段格式（重点）](#message-字段格式重点)
  - [1. 纯文本格式](#1-纯文本格式)
  - [2. 消息段数组格式](#2-消息段数组格式)
  - [Chat API 的 message 用法](#chat-api-的-message-用法)
  - [IM Message API 的 message 用法](#im-message-api-的-message-用法)
- [示例](#示例)
- [完整 API 文档](#完整-api-文档)
...
- 原始文档: https://docs.astrbot.app/dev/openapi.html
- 整理时间: 2026-06-17
